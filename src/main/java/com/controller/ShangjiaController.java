...
public class ShangjiaController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ShangjiaEntity u = shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("dianpuzhanghao", username));
    ...
    public R register(@RequestBody ShangjiaEntity shangjia){
    	...
    	ShangjiaEntity u = shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("dianpuzhanghao", shangjia.getDianpuzhanghao()));
		if(u!=null) {
