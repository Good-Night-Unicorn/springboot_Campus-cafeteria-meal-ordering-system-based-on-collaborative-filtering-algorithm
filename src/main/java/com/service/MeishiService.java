...
public interface MeishiService extends IService<MeishiEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<MeishiEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<MeishiEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<MeishiEntity> wrapper);
