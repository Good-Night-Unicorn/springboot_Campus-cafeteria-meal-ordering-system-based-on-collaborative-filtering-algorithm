...
<div class="content" :style='{"minHeight":"100vh","padding":"0px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url() no-repeat center top / cover,#e9ecf3","display":"block","fontSize":"14px","height":"auto"}'>
	...
	<div :style='{"border":"0px solid #bababa","padding":"0","margin":"10px 0 20px","alignItems":"flex-start","color":"#fff","display":"flex","justifyContent":"center","overflow":"hidden","borderRadius":"0px","flexWrap":"wrap","background":"none","width":"100%","fontSize":"14px","order":"0"}'>
		<div :style='{"padding":"20px","margin":"0 2% 12px 0","borderColor":"#e7e8f8","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"flex-start","overflow":"hidden","borderRadius":"5px","background":"#3598dc","borderWidth":"0px","flex":"1","width":"18%","position":"relative","borderStyle":"solid"}' v-if="isAuth('meishi','首页总数')">
			...
			<div :style='{"margin":"0 0 0 20px","alignItems":"flex-end","textAlign":"left","flexDirection":"column","background":"none","display":"flex","width":"calc(100% - 70px)","justifyContent":"center"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"500","height":"24px"}'>{{meishiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"inherit","height":"24px"}'>美食总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="type5" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"3"}'>
		<div id="meishiChart1" class="echarts1" v-if="isAuth('meishi','首页统计')"></div>
		<div id="meishiChart2" class="echarts2" v-if="isAuth('meishi','首页统计')"></div>
		<div id="meishiChart3" class="echarts3" v-if="isAuth('meishi','首页统计')"></div>
		<div id="meishiChart4" class="echarts4" v-if="isAuth('meishi','首页统计')"></div>
		<div id="meishiChart5" class="echarts5" v-if="isAuth('meishi','首页统计')"></div>
	</div>
</div>
</template>
<script>
