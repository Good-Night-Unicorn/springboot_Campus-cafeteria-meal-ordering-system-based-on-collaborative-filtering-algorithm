	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"14px","color":"#666","background":"#e9ecf3"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="副标题" prop="subtitle">
					<el-input  v-model="ruleForm.subtitle" placeholder="副标题" clearable  :readonly="ro.subtitle"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else class="input" label="副标题" prop="subtitle">
					<el-input v-model="ruleForm.subtitle" placeholder="副标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="upload" v-if="type!='info' && !ro.picture1" label="图片1" prop="picture1">
					<file-upload
						tip="点击上传图片1"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="upload" v-else-if="ruleForm.picture1" label="图片1" prop="picture1">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="upload" v-if="type!='info' && !ro.picture2" label="图片2" prop="picture2">
					<file-upload
						tip="点击上传图片2"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="upload" v-else-if="ruleForm.picture2" label="图片2" prop="picture2">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="upload" v-if="type!='info' && !ro.picture3" label="图片3" prop="picture3">
					<file-upload
						tip="点击上传图片3"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="upload" v-else-if="ruleForm.picture3" label="图片3" prop="picture3">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../springboot38r71ot7/upload');
        } else {
