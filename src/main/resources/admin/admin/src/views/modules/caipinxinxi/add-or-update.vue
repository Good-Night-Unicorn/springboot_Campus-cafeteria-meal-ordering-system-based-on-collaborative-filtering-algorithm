	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"14px","color":"#666","background":"#e9ecf3"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="菜品类型" prop="caipinleixing">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="upload" v-if="type!='info' && !ro.caipintupian" label="菜品图片" prop="caipintupian">
					<file-upload
						tip="点击上传菜品图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="upload" v-else-if="ruleForm.caipintupian" label="菜品图片" prop="caipintupian">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="菜品食材" prop="caipinshicai">
					<el-input  v-model="ruleForm.caipinshicai" placeholder="菜品食材" clearable  :readonly="ro.caipinshicai"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else class="input" label="菜品食材" prop="caipinshicai">
					<el-input v-model="ruleForm.caipinshicai" placeholder="菜品食材" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="单限" prop="onelimittimes">
					<el-input  v-model.number="ruleForm.onelimittimes" placeholder="单限" clearable  :readonly="ro.onelimittimes"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else class="input" label="单限" prop="onelimittimes">
					<el-input v-model="ruleForm.onelimittimes" placeholder="单限" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="库存" prop="alllimittimes">
					<el-input  v-model.number="ruleForm.alllimittimes" placeholder="库存" clearable  :readonly="ro.alllimittimes"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else class="input" label="库存" prop="alllimittimes">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="菜品介绍" prop="caipinjieshao">
					<el-input
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else-if="ruleForm.caipinjieshao" label="菜品介绍" prop="caipinjieshao">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.caipinjieshao}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(((json.dianpuzhanghao!=''&&json.dianpuzhanghao) || json.dianpuzhanghao==0) && this.$storage.get("role")!="管理员"){
					...
					if(((json.dianpudizhi!=''&&json.dianpudizhi) || json.dianpudizhi==0) && this.$storage.get("role")!="管理员"){
