			...
			<el-form class="center-form-pv" :style='{"border":"0px solid #ddd","padding":"20px 20px 0","margin":"0px 0 0","overflow":"hidden","borderRadius":"0px","flexWrap":"wrap","background":"#fff","display":"flex","width":"auto","fontSize":"inherit","justifyContent":"space-between"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"0px","margin":"0 0 10px","borderRadius":"0px","textAlign":"center","flexWrap":"wrap","background":"#fff","flexDirection":"row","display":"flex","width":"auto","fontSize":"inherit","order":"2"}' >
					<div :style='{"margin":"0 10px 0 0","fontSize":"inherit","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">店铺账号</label>
						<el-input v-model="searchForm.dianpuzhanghao" placeholder="店铺账号" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","fontSize":"inherit","display":"flex"}'>
					...
					<el-table-column :resizable='true' :sortable='true' prop="dianpuzhaopian" width="200" label="店铺照片">
						<template slot-scope="scope">
							<div v-if="scope.row.dianpuzhaopian">
								<img v-if="scope.row.dianpuzhaopian.substring(0,4)=='http'" :src="scope.row.dianpuzhaopian.split(',')[0]" width="100" height="100">
								<img v-else :src="$base.url+scope.row.dianpuzhaopian.split(',')[0]" width="100" height="100">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
