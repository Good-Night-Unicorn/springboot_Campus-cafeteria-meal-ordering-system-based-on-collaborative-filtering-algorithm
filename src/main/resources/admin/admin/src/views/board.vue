<template>
	<div class="content" :style='{"alignContent":"flex-start","overflow":"hidden","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/a8c4412078c84883902ad3bedef73407.jpg) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"100vh"}'>
			...
			<div :style='{"width":"25%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 30px)"}'>
						<div id="meishiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"30px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 30px)"}'>
						<div id="meishiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"30px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 30px)"}'>
						<div id="meishiChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"20px 20px","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/26d4501d35db46278b1d99be2f14602f.png) no-repeat center top / 100% 100%","display":"flex","width":"calc(50% - 20px)","fontSize":"14px","height":"calc(40% - 20px)","order":"2"}'>
					...
					<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,0)","justifyContent":"center","display":"flex"}'>
						...
						<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>美食总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{meishiCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="meishiChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"25%","flexWrap":"wrap","display":"flex"}'>
				<div class="tables">
					<div :style='{"margin":"0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,0)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px"}'>美食</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#5c89e6","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="name" label="店名"/>
						</el-table-column>
						...
						<el-table-column :resizable="true" :sortable="false" prop="price" label="人均"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="recommentcount" label="点评数"/>
						</el-table-column>
					</el-table>
				</div>
				<div class="echarts5">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="meishiChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
//统计接口1
    meishiChat1() {
      this.$nextTick(()=>{
        ...
        var meishiChart1 = echarts.init(document.getElementById("meishiChart1"),'macarons');
        this.$http({
            url: "meishi/group/caixi",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
...
//统计接口2
    meishiChat2() {
      this.$nextTick(()=>{
        ...
        var meishiChart2 = echarts.init(document.getElementById("meishiChart2"),'macarons');
        this.$http({
            url: "meishi/group/dianpin",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
...
//统计接口3
    meishiChat3() {
      this.$nextTick(()=>{
        ...
        var meishiChart3 = echarts.init(document.getElementById("meishiChart3"),'macarons');
        this.$http({
            url: `meishi/value/name/score`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
...
//统计接口4
    meishiChat4() {
      this.$nextTick(()=>{
        ...
        var meishiChart4 = echarts.init(document.getElementById("meishiChart4"),'macarons');
        this.$http({
            url: `meishi/value/name/price`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
...
//统计接口5
    meishiChat5() {
      this.$nextTick(()=>{
        ...
        var meishiChart5 = echarts.init(document.getElementById("meishiChart5"),'macarons');
        this.$http({
            url: `meishi/value/name/recommentcount`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
